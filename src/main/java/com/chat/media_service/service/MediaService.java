...
public class MediaService {
    ...
    public Mono<ResponseEntity<CommonResponse>> uploadImage(String operation, String requestId, Mono<FilePart> filePart) {
        ...
        return createFileFromFilePart(filePart)
                ...
                .map(uploadResult -> {
                    ...
                    CommonResponse imageUploadedSuccessfully = CommonResponse.builder().message("Image uploaded successfully")
                            .requestId(requestId)
                            .data(uploadResult)
                            .build();
    ...
    private Mono<File> createFileFromFilePart(Mono<FilePart> filePartMono) {
        return filePartMono.flatMap(filePart -> {
            ...
            return reduce.flatMap(dataBuffer -> {
